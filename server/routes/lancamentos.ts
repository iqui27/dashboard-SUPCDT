...
router.put('/:id', requireAuth, async (req, res) => {
    try {
        ...
        if (trimestre !== undefined) updateFields.trimestre = trimestre;
        if (descricaoAtividade !== undefined) updateFields.descricaoAtividade = descricaoAtividade;
        if (localAtendido !== undefined) updateFields.localAtendido = localAtendido;
        if (valores !== undefined) updateFields.valores = valores;
        if (dataAtividade !== undefined) updateFields.dataAtividade = dataAtividade;
