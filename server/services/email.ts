...
async function ensureTransporter(): Promise<nodemailer.Transporter> {
  if (!transporter) {
...
export async function sendPasswordResetEmail({ to, username, resetLink }: PasswordResetEmailOptions): Promise<void> {
