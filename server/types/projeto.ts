...
export type ProjetoHistoricoAcao = 'criado' | 'atualizado' | 'lancamento';

export interface DBProjetoHistoricoUsuario {
  userId?: string | null;
  username: string;
  fullName?: string | null;
}

export interface DBProjetoHistoricoAlteracao {
  campo: string;
  antes?: string | null;
  depois?: string | null;
}

export interface DBProjetoHistoricoItem {
  id: string;
  acao: ProjetoHistoricoAcao;
  data: Date;
  resumo: string;
  usuario: DBProjetoHistoricoUsuario;
...
export interface DBProjeto {
  ...
  historicoAlteracoes?: DBProjetoHistoricoItem[];
  createdAt?: Date;
  updatedAt?: Date;
}
