...
function buildSheetProjectId(index, numeroTermo, processo, projeto) {
...
export async function fetchSheetProjects() {
...
export async function fetchParlamentaresFromSheet() {
    if (!GOOGLE_SHEETS_API_KEY || !GOOGLE_SHEET_ID) {
