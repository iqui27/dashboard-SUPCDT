    ...
    try {
        ...
        for (const collection of collections) {
            ...
            if (count > 0) {
                ...
                const hasParlamentar = samples.some((doc) => doc.parlamentar !== undefined);
                const hasParlamentares = samples.some((doc) => doc.parlamentares !== undefined);
                const hasEmendas = samples.some((doc) => doc.emendasParlamentares !== undefined);
