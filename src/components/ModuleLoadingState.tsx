...
export function ModuleLoadingState({
  ...
  return (
    <div className="space-y-5">
      <div className="overflow-hidden rounded-[1.65rem] border border-white/80 bg-[radial-gradient(circle_at_top_left,rgba(14,116,144,0.10),transparent_36%),linear-gradient(135deg,rgba(255,255,255,0.95),rgba(255,255,255,0.72))] p-5 shadow-[0_30px_80px_-45px_rgba(15,23,42,0.35)]">
        <div className="max-w-2xl">
          <div className="h-3 w-32 animate-pulse rounded-full bg-sky-100" />
          <div className="mt-4 h-9 w-4/5 animate-pulse rounded-2xl bg-slate-100" />
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="rounded-[1.45rem] border border-white/80 bg-white/85 p-5 shadow-[0_20px_70px_-42px_rgba(15,23,42,0.35)]">
      ...
      <div className="rounded-[1.45rem] border border-white/80 bg-white/85 px-6 py-7 text-center shadow-[0_24px_70px_-42px_rgba(15,23,42,0.35)]">
