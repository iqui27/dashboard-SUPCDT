      ...
      <div className="mt-3 space-y-2">
        {series.map((s, idx) => (
          <div key={idx} className="flex items-center gap-2">
            <span className="w-28 truncate text-xs text-muted-foreground">{s.label}</span>
            ...
            <span className="w-12 text-right text-xs font-semibold text-foreground">{s.valor}</span>
          </div>
        ))}
      </div>
    );
    ...
    <div className="overflow-hidden rounded-[1.35rem] border border-border/80 bg-card/80 shadow-sm">
      <div className="flex items-center justify-between px-5 py-4">
        <div>
          ...
          <h3 className="mt-0.5 text-sm font-bold text-foreground">Indicadores de Pesquisa</h3>
        </div>
        <Button
          variant="outline"
          size="sm"
          ...
          <div className="divide-y divide-border/70 border-b border-border/70 bg-muted/50 px-5 py-4">
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <label className="text-xs font-medium text-muted-foreground">Série de dados</label>
              ...
              <li key={indicador.id} className="flex items-start justify-between gap-3 px-5 py-4">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    <h4 className="text-sm font-semibold text-foreground">{indicador.nome}</h4>
                    {indicador.categoria && (
