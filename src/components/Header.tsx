...
function BrandMark() {
  return (
    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[linear-gradient(135deg,#0f172a_0%,#0f766e_100%)] text-white shadow-[0_18px_36px_-24px_rgba(15,23,42,0.75)]">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <h1 className="text-lg font-extrabold tracking-tight text-slate-950 sm:text-xl">Dashboard SUPCDT</h1>
                <p className="text-[13px] text-slate-500">Monitoramento institucional de projetos e operações</p>
              </div>
            </div>

            <div className="flex items-center gap-2.5 xl:gap-3">
              <div className="hidden rounded-xl border border-white/80 bg-white/80 px-3.5 py-2 shadow-sm sm:block">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Projetos monitorados</p>
                <p className="mt-1 text-sm font-semibold text-slate-950">{projetosCount}</p>
              </div>
          ...
          {showTabs && (
            <div className="hidden items-center justify-between gap-4 md:flex">
              {renderTabs(false)}
              <div className="rounded-full bg-white/70 px-3.5 py-1.5 text-[13px] text-slate-500 shadow-sm">
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="rounded-[1.35rem] border border-white/80 bg-white/80 px-4 py-3.5 shadow-sm lg:max-w-[62%]">
              ...
              <p className="mt-2.5 text-sm font-semibold text-slate-950">{activeContextTitle || currentTabLabel}</p>
              <p className="mt-1 text-[13px] text-slate-500">{activeContextDescription || 'Área ativa do dashboard institucional.'}</p>
            </div>

            <div className="grid gap-3 sm:grid-cols-2 lg:w-[380px]">
              <div className="rounded-[1.35rem] border border-white/80 bg-white/80 px-4 py-3 shadow-sm">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Módulo atual</p>
                <p className="mt-1.5 text-sm font-semibold text-slate-950">{currentTabLabel}</p>
              </div>
              <div className="rounded-[1.35rem] border border-white/80 bg-white/80 px-4 py-3 shadow-sm">
                <p className="text-xs uppercase tracking-[0.18em] text-slate-500">Carteira carregada</p>
                <p className="mt-1.5 text-sm font-semibold text-slate-950">{projetosCount} projeto(s)</p>
              </div>
            </div>
          </div>

          {showTabs && mobileNavOpen && (
            <div className="rounded-[1.35rem] border border-white/80 bg-white/90 p-4 shadow-[0_20px_50px_-30px_rgba(15,23,42,0.45)] md:hidden">
              {renderTabs(true)}
