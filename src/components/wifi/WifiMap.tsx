...
export function WifiMap({ points, onCreateAt, onEditPoint }: WifiMapProps) {
  ...
  return (
    <div className="overflow-hidden rounded-[1.75rem] border border-white/80 bg-white/85 shadow-[0_24px_70px_-42px_rgba(15,23,42,0.35)]">
      <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
        <div>
          <h3 className="text-lg font-semibold text-slate-950">Mapa do DF</h3>
          <p className="mt-1 text-sm text-slate-500">Clique no mapa para cadastrar um novo ponto com coordenadas preenchidas.</p>
        </div>
